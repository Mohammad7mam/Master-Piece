                                ...
                                @foreach (auth()->user()->unreadNotifications as $notification)
                                    <div class="main-notification-list Notification-scroll">
                                        <a class="d-flex p-3 border-bottom"
                                            ...
                                            <div class="notifyimg bg-pink" style="width: 3rem ; hight:50rem ; background-color:blue">
...
{{--                                 <div class="main-img-user" style="width: 2rem; height: 2rem; padding : 2px"><img  alt="" src="{{ URL::asset('assets/img/faces/6.jpg') }}" 
                                class="" style="padding: "> 
                                </div>
